...
class EntsoeException(PriceProviderError):
    pass
...
class EntsoeProvider(PriceProvider):
    ...
    async def query_day_ahead_prices(
            self, area: Union[Area, str], start: datetime, end: datetime
    ) -> dict:
        """
        Parameters
        ----------
        ...
        str
        """
        area_enum = Area[area.upper()]
        params = {
            "documentType": "A44",
            "in_Domain": area_enum.code,
            "out_Domain": area_enum.code,
        }
